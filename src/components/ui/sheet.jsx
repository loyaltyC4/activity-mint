...
/**
 * Side drawer that slides in from an edge. Uses the same Radix dialog
 * primitive as <Dialog> but with positional variants.
 * Used by the Tools pane to surface each tool's interactive UI without
 * navigating away.
 */
